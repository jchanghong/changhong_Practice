 ...
 */
public class TimeIndexScroller {
	...
	public TimeIndexScroller(Context context, GridView lv) {
	...
	public void draw(Canvas canvas) {
		...
		canvas.drawRoundRect(mIndexbarRect,
                5 * mDensity, 5 * mDensity,
                indexbarPaint);
